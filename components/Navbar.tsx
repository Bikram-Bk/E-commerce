        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0">
              <span className="text-2xl font-bold bg-gradient-to-r from-green-500 via-blue-500 to bg-red-400 bg-clip-text text-transparent">
                BikramShop
              </span>
            </Link>
          </div>
            ...
            <div>
              <Link href="/cart" onClick={handleMenuItemClick}>
                <Button
                  ...
                  {cartItems.length > 0 && (
                    <span
                      className="absolute top-[-3px] right-[-3px] inline-flex items-center justify-center px-2 py-1 
                ...
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    <Avatar className="h-8 w-8 cursor-pointer">
                      ...
                      to-red-500 hover:from-purple-600 hover:via-pink-600 hover:to-red-600 text-white">
                        {user.formData
                          .find(
                ...
                <DropdownMenuContent className="w-56 " align="end" forceMount>
                  <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                      <p
                        className="text-sm font-medium leading-none bg-gradient-to-r 
              ...
              <div className="flex space-x-2">
                <div>
                  <Link href="/auth?type=login">
                    <Button
                      variant="outline"
                      className="bg-gradient-to-r from-green-500 via-blue-500 to bg-red-400
          ...
          <div className="border-t border-gray-700 pt-4 pb-3">
            {user && (
              <div className="flex items-center px-5 mb-3">
                ...
                <div className="ml-3">
                  <div
                    className="text-base font-medium bg-gradient-to-r 
                  from-purple-600 via-pink-500 to-red-500 bg-clip-text text-transparent">
                    {
                      user.formData.find(
                        (f): f is { marker: "name"; value: string } =>
            ...
            {user ? (
              <div className="mt-3 px-2 space-y-1">
                ...
                <button
                  onClick={handleLogout}
                  className="block px-3 py-2 rounded-md text-base font-medium 
                  text-gray-500 hover:text-white hover:bg-purple-500 w-full text-left cursor-pointer">
                  Log out
                </button>
              </div>
            ) : (
